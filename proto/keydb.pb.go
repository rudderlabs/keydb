...
const (
	...
	ErrorCode_DEGRADED       ErrorCode = 4 // Node is in degraded mode and not serving GET/PUT traffic
)
...
type GetNodeInfoResponse struct {
	...
	DegradedMode          bool                   `protobuf:"varint,6,opt,name=degraded_mode,json=degradedMode,proto3" json:"degraded_mode,omitempty"`                              // Indicates if this node is in degraded mode (not serving GET/PUT traffic)
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *GetNodeInfoResponse) GetDegradedMode() bool {
	if x != nil {
...
const file_proto_keydb_proto_rawDesc = "" +
	...
	"\anode_id\x18\x01 \x01(\rR\x06nodeId\"\xf7\x01\n" +
	...
	"hashRanges\x126\n" +
	"\x17last_snapshot_timestamp\x18\x05 \x01(\x04R\x15lastSnapshotTimestamp\x12#\n" +
	"\rdegraded_mode\x18\x06 \x01(\bR\fdegradedMode\"^\n" +
	...
	"\x0eINTERNAL_ERROR\x10\x03\x12\f\n" +
	"\bDEGRADED\x10\x042\xdb\x03\n" +
	"\vNodeService\x12.\n" +
